...
<script type="text/javascript">
    ...
    function searchCourses() {
      ...
      $.ajax({
        type: 'POST',
        url: '/Practice/Teacher/ssearchCourses',
        data: 'val=' + val,
        dataType: "json",
        global: false,
    ...
    function searchPractices777() {
      ...
      var text = $.ajax({
        url: "/Practice/Teacher/searchPractices?val=" + val,
        async: false
      });
      alert(text);
    };
...
<body onload="onLi()">
  <div class="wrapper">
    <div class="main-header text-white" style="background: #6c757d70;">
      <div class="logo-header align-middle">
        <a href="" class="logo text-white"> 练习题管理系统 </a>
        ...
        <div class="container-fluid text-center">
          ...
          <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
              ...
              <ul class="dropdown-menu notif-box" aria-labelledby="navbarDropdown">
                ...
                <li>
                  <div class="notif-center">
                    ...
                    <a href="#">
                      <div class="notif-img">
                        <img src="http://localhost:8080/Practice/images/nan.png" alt="Img Profile">
                      </div>
                      <div class="notif-content">
            ...
            <li class="nav-item dropdown">
              <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false"> <img src="http://localhost:8080/Practice/images/nan.png" alt="user-img" width="36" class="img-circle"><span>葛祥友</span> </a>
              <ul class="dropdown-menu dropdown-user">
                <li>
                  <div class="user-box">
                    <div class="u-img"><img src="http://localhost:8080/Practice/images/nan.png" alt="user"></div>
                    <div class="u-text">
                      <h4>葛祥友</h4>
    ...
    <div class="sidebar " style="background: #D9DEE4;">
      <div class="scrollbar-inner sidebar-wrapper" style="">
        <div class="user">
          <div class="photo">
            <img src="http://localhost:8080/Practice/images/nan.png">
          </div>
          <div class="info">
            ...
            <div class="card card-tasks">
              <div class="card-body ">
                <div class="row p-1 text-center">
                  <h4 class="page-title m-0 pl-2 pr-2 pb-0">课程管理</h4>
                  <div class="card-header p-0 pb-0 ">
                    <form class="card-title navbar-left navbar-form nav-search mr-md-3" action="">
                      <div class="input-group">
                        <input id="ssearchCoursesVal" type="text" placeholder="输入关键字搜索课程 ..." class="form-control" onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;searchCourses();}" >
                ...
                <div class="table-full-width">
                  <table class="table">
                    <thead>
                      <tr>
                        <th> 课程: <div class="btn-group p-0 ml-2">
                            <button class="btn btn-outline-dark dropdown-toggle" data-toggle="dropdown"> 2019 </button>
                    ...
                    <tbody id="“coursesTbody”">
                      <tr>
                        <td><a href="/Practice/Teacher/getPracticeByCourseId/30">移动应用开发</a></td>
                        <td>2</td>
                        <td>5</td>
                        <td class="td-actions text-left">
                          <div class="form-button-action">
                            <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-simple-danger" data-original-title="删除"><i class="la la-times" onclick="deleteCourse('30')">删除</i></button>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td><a href="/Practice/Teacher/getPracticeByCourseId/31">算法分析</a></td>
                        <td>Name</td>
                        <td>1</td>
                        <td class="td-actions text-left">
                          <div class="form-button-action">
                            <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-simple-danger" data-original-title="删除"><i class="la la-times" onclick="deleteCourse('31')">删除</i></button>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td><a href="/Practice/Teacher/getPracticeByCourseId/32">安卓应用基础</a></td>
                        <td>Name</td>
                        <td>0</td>
                        <td class="td-actions text-left">
                          <div class="form-button-action">
                            <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-simple-danger" data-original-title="删除"><i class="la la-times" onclick="deleteCourse('32')">删除</i></button>
                          </div>
                        </td>
                      </tr>
                    </tbody>
