        ...
        <div class="collapse navbar-collapse" id="navbar5">
            <c:if test="${user!=null}">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item"> <a class="nav-link text-white" href="<%=basePath%>Admin/AdminTeacherIndexUrl">教师管理</a> </li>
                    <li class="nav-item"> <a class="nav-link text-white" href="#">学生管理</a> </li>
                    <li class="nav-item"> <a class="nav-link text-white" href="<%=basePath%>ApiIndex/adminApiIndexUrl">Api</a> </li>
                </ul>
