        ...
        <div class="collapse navbar-collapse" id="navbar5">
            <c:if test="${user!=null}">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item"> <a class="nav-link text-white" href="<%=basePath%>apiIndex/apiIndexUrl">Api</a> </li>
                </ul>
            ...
            <c:if test="${user==null}">
                ...
                <a class="btn navbar-btn ml-md-2 btn-outline-light"  href="<%=basePath%>/register/addUser">注册</a>
            </c:if>
        </div>
    </div>
</nav>
